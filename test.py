...
cl = LINETCR.LINE()
cl.login(token="EAJPPYZVT6wZFHFklfR2.hqz8HFnPjZzYz8Pb1cegWG.DMxUnzXaRcRljmG6r6xT8oGnkdRvrH7oTQpLuJ/L61g=")
cl.loginResult()
...
targets = []
mid = cl.getProfile().mid
Bots = ["u1d067c85f36927367267ca41d42106c2",mid]
self = ["u1d067c85f36927367267ca41d42106c2",mid]
admin = "u1d067c85f36927367267ca41d42106c2"
admsa = "u1d067c85f36927367267ca41d42106c2"
owner = "u1d067c85f36927367267ca41d42106c2"
adminMID = "u1d067c85f36927367267ca41d42106c2"
Creator="u1d067c85f36927367267ca41d42106c2"
wait = {
    "alwayRead":False,
    "detectMention":False,    
    "kickMention":False,
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["เดี๋ยวว่างแล้วจะมาตอบนะ"]
                     ret_ = "นี่เป็นข้อความตอบกลับอัตโนมัติ " + random.choice(balas)
...
#========================================
                ...
                wait["message"] = msg.text.replace("กันรัน:","")
                ...
                cl.sendText(msg.to,"-- List Groups --\n\n"+ h +"\nTotal groups =" +" ["+str(len(gid))+"]")
                 ...
                 if jml > 340 and jml <= 360:
                    ...
                    for y in range (300, 320):
                        nm16 += [nama[y]]
                    summon(msg.to, nm16)
                    for z in range (320, 340):
                        nm17 += [nama[z]]
                    summon(msg.to, nm17)
                    for a in range (340, len(nama)-1):
                        nm18 += [nama[a]]
                    summon(msg.to, nm18)
                 ...
                 if jml > 400 and jml <= 420:
                    ...
                    for b in range (360, 380):
                        nm19 += [nama[b]]
                    summon(msg.to, nm19)
                    for c in range (380, 400):
                        nm20 += [nama[c]]
                    summon(msg.to, nm20)
                    for d in range (400, len(nama)-1):
                        nm21 += [nama[d]]
                    summon(msg.to, nm21)
                 if jml > 420 and jml <= 440:
                    ...
                    for c in range (380, 400):
                        nm20 += [nama[c]]
                    summon(msg.to, nm20)
                    for d in range (400, 420):
                        nm21 += [nama[d]]
                    summon(msg.to, nm21)
                    for e in range (420, len(nama)-1):
                        nm22 += [nama[e]]
                    summon(msg.to, nm22)
                 ...
                 if jml > 460 and jml <= 480:
                    ...
                    for f in range (440, 460):
                        nm23 += [nama[f]]
                    summon(msg.to, nm23)
                    for g in range (460, len(nama)-1):
                        nm24 += [nama[g]]
                    summon(msg.to, nm24)
                 if jml > 480 and jml <= 500:
                    for i in range (0, 20):
                        nm1 += [nama[i]]
                    summon(msg.to, nm1)
                    for j in range (20, 40):
                    ...
                    for f in range (440, 460):
                        nm23 += [nama[f]]
                    summon(msg.to, nm23)
                    for g in range (460, 480):
                         nm24 += [nama[g]]
                    summon(msg.to, nm24)
                    for h in range (480, len(nama)-1):
                        nm25 += [nama[h]]
                    summon(msg.to, nm25)
                 if jml > 500:
        ...
        if op.type == 26:
            ...
            if msg.text.lower() in ["1123"]:
                ...
                cl.sendMessage(cnt)
                        ...
                        cl.sendText(msg.to,"ไม่ต้องห่วงๆ ยังอยู่ๆ")
